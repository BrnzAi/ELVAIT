...
export function AuthPrompt({ 
  ...
  return (
    <div className="bg-elvait-green/5 border border-elvait-green/30 rounded-xl p-6">
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-xl bg-elvait-red/20 flex items-center justify-center flex-shrink-0">
