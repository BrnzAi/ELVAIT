        ...
        <div className="p-6 lg:p-8 max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">Manage industry categories for assessments</p>
            </div>
            ...
            <table className="w-full">
              <thead className="border-b border-white/[0.06]">
                <tr>
                  ...
                  <th className="text-left p-4 text-sm font-medium text-gray-400">Organizations</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">Assessments</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-400">Avg ICS</th>
                  ...
                  <tr key={industry.id} className="hover:bg-white/[0.02]">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-elvait-green/10 flex items-center justify-center">
                          <Factory className="w-5 h-5 text-elvait-green" />
                        </div>
                        <div>
