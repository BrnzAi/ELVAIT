...
export default function SurveyPage() {
  ...
  if (showContext) {
    return (
      <div className="min-h-screen bg-[#F0F0F0]">
        <header className="bg-white border-b border-[#B4B4B4]">
        ...
        <main className="max-w-3xl mx-auto px-6 py-12">
          <div className="bg-white rounded-xl border border-[#B4B4B4] p-8">
            ...
            <p className="text-[#777777] mb-6">{surveyData.context.description}</p>
            
            <div className="space-y-4 mb-8">
              <div className="p-4 bg-[#F0F0F0] rounded-lg">
                <p className="text-sm text-[#777777] mb-1">What decision are we actually trying to make?</p>
                <p className="font-medium">{surveyData.context.dCtx1}</p>
              </div>
              <div className="p-4 bg-[#F0F0F0] rounded-lg">
                <p className="text-sm text-[#777777] mb-1">What will be different if this decision succeeds?</p>
                <p className="font-medium">{surveyData.context.dCtx2}</p>
              </div>
              <div className="p-4 bg-[#F0F0F0] rounded-lg">
                <p className="text-sm text-[#777777] mb-1">What happens if we do nothing?</p>
                <p className="font-medium">{surveyData.context.dCtx3}</p>
              </div>
              <div className="p-4 bg-[#F0F0F0] rounded-lg">
                <p className="text-sm text-[#777777] mb-1">What would make this decision a mistake in hindsight?</p>
            ...
            <div className="p-4 bg-[#F0F0F0] rounded-lg mb-6 border border-[#B4B4B4]">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 rounded border-[#B4B4B4] text-brand-green focus:ring-brand-green"
                />
  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0]">
      <header className="bg-white border-b border-[#B4B4B4] sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-6 py-4">
          ...
          <div className="h-1 bg-[#B4B4B4] rounded-full overflow-hidden">
            <div 
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white rounded-xl border border-[#B4B4B4] p-8">
                  ...
                  className={`w-full p-4 rounded-lg border text-left transition-all flex items-center gap-4 ${
                    (() => {
                      ...
                      return responses[responseKey] === option.value
                        ...
                        : 'border-[#B4B4B4] hover:border-[#B4B4B4]';
                    })()
                  }`}
                >
                  ...
                  <div>
                    ...
                    <span className="text-[#777777] ml-2">— {option.label}</span>
                  </div>
                </button>
              ))}
            </div>
          ...
          {/* Navigation */}
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#B4B4B4]">
            <Button
              variant="outline"
